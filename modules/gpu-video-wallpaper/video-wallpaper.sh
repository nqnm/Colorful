...
# fork: https://github.com/nozerobit/gpu-video-wallpaper 
...
start() {
    ...
    # Temporary Solution for VM resolution issue.
    # Ideally, the wallpaper resolution should change on X11 events
    # This is not a 'good' solution but it should do the work for now.
